...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        $driverOrdersQuery = clone $driverOrdersObj;

        $driverOrders = $driverOrdersQuery->where('is_completed', false)->with('order')->orderBy('id', 'DESC');

        $total = $driverOrders->count();

        $toDoOrder = $driverOrdersQuery->where('is_completed', false)->count();
        $completedOrder = $driverOrdersQuery->where('is_completed', true)->count();
    ...
    public function statusWiseOrders(Request $request)
    {
        ...
        $driverOrders = $driverOrdersQuery->when($search, function ($query) use ($search) {
        ...
        $totalDelivered = $driverOrdersQuery->where('is_completed', true)->count();
        $totalToDeliver = $driverOrdersQuery->where('is_completed', false)->count();
